...
resource "aws_ecs_cluster" "main" {
  ...
  tags = { Name = "${var.name_prefix}-cluster", Environment = var.environment }
}
...
resource "aws_security_group" "frontend" {
  ...
  description = "Frontend tasks — allow from ALB only"
  vpc_id      = var.vpc_id
...
resource "aws_lb" "main" {
  ...
  tags = { Name = "${var.name_prefix}-alb", Environment = var.environment }
}
...
resource "aws_lb_listener_rule" "api" {
  ...
  condition {
    path_pattern { values = ["/api/*", "/docs", "/openapi.json", "/health", "/health/*"] }
  }
}
...
resource "aws_ecs_task_definition" "worker" {
  ...
  container_definitions = jsonencode([{
    ...
    environment = var.worker_env_vars
...
resource "aws_appautoscaling_policy" "api_memory" {
  name               = "${var.name_prefix}-api-scale-mem"
  policy_type        = "TargetTrackingScaling"
  resource_id        = aws_appautoscaling_target.api.resource_id
  scalable_dimension = aws_appautoscaling_target.api.scalable_dimension
  service_namespace  = aws_appautoscaling_target.api.service_namespace
...
resource "aws_appautoscaling_policy" "worker_cpu" {
  name               = "${var.name_prefix}-worker-scale-cpu"
  policy_type        = "TargetTrackingScaling"
